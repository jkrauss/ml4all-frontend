...
>
  ...
  <Datatable>
            ...
            <div class="relative">
              ...
              <div class="absolute right-0 top-0 bottom-0">
                <span
                  ...
                  class:text-gray-200={sortBy.col == key && !sortBy.ascending}
                  class:text-gray-500={sortBy.col != key || sortBy.ascending}
                >
                  arrow_drop_up
                </span>
                <span
    ...
    {#each displayData as dataRow, i}
      ...
      {#if i < pageLength * currentPage && i >= pageLength * (currentPage - 1)}
        <!-- creating new row -->
        <tr
          style={`background: ${i % 2 ? styling.even?.bg : styling.odd?.bg};
  ...
  <div class="w-full flex">
    ...
    <div class="ml-auto rounded-lg overflow-hidden flex ">
      ...
      {/if}
      <!-- curent pagenumber -->
      <div class="px-4 py-2 m-0 h-full text-white" style="background: #1d913a;">
        {currentPage}
      </div>
      <!-- next pagenumber -->
